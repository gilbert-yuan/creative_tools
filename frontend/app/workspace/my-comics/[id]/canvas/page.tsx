                        ...
                        {projectData.scenes.map(scene => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <Box aspectRatio="9/16" bg="blackAlpha.400" position="relative">
                                        {isReplacing ? (
                                            <Flex
                                                direction="column"
                                                align="center"
                                            ...
                                            url ? (
                                                activeTab === 'image' ? (
                                                    <Image src={getImageUrl(url)} w="full" h="full" objectFit="cover" />
                                                ) : (
                                                    <video
                                                        src={getImageUrl(url)}
                                            ...
                                            {historyItems.map((item, idx) => (
                                                <Box key={item.id} flexShrink={0} w="180px">
                                                    <Box position="relative">
                                                        ...
                                                        <Box aspectRatio="9/16" bg="blackAlpha.500" borderRadius="none" overflow="hidden" mb={2}>
                                                            {activeTab === 'image' ? (
                                                                <Image src={getImageUrl(item.result_url)} w="full" h="full" objectFit="cover" />
                                                            ) : (
                                                                <video src={getImageUrl(item.result_url)} controls style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                                            )}
                                                        </Box>
                                                    </Box>
                                                </Box>
